...
const Navbar = () => {
  ...
  // Detect scroll position for navbar appearance
  useEffect(() => {
    const handleScroll = () => {
  ...
  // Close dropdown and menu when changing routes
  useEffect(() => {
    setIsMenuOpen(false);
    setShowUserDropdown(false);
  }, [location]);
    ...
    <nav ref={navbarRef} className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
      <div className="container navbar-container">
        <Link to="/" className="navbar-logo">
          ...
          <span className="logo-text">FoodResQ</span>
        </Link>
        ...
        <ul className={`navbar-menu ${isMenuOpen ? 'active' : ''}`}>
          <li className="navbar-item">
            <Link to="/" className={`navbar-link ${isActive('/')}`}>
              <svg className="navbar-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="navbar-item">
            <Link to="/food" className={`navbar-link ${isActive('/food')}`}>
              <svg className="navbar-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {isAuthenticated ? (
            <>
              ...
              <li className="navbar-item">
                <Link to="/food-waste-reduction" className={`navbar-link ${isActive('/food-waste-reduction')}`}>
                  <svg className="navbar-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M7.75732 7.75732L16.2426 16.2426" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M7.75732 16.2426L16.2426 7.75732" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span>Reduce Waste</span>
                </Link>
              </li>
              <li className="navbar-item user-dropdown-container" ref={dropdownRef}>
                <button 
                ...
                >
                  ...
                  <span className={`dropdown-arrow ${showUserDropdown ? 'up' : 'down'}`}></span>
                </button>
                ...
                {showUserDropdown && (
                  <div className="user-dropdown">
                    <div className="dropdown-user-info">
                      ...
                      <div className="dropdown-user-role">{user?.role === 'admin' ? 'Administrator' : 'User'}</div>
                    </div>
                    ...
                    {user?.role === 'admin' && (
                      <Link to="/admin/food/create" className="dropdown-item">
                        <svg className="dropdown-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <>
              <li className="navbar-item navbar-auth-buttons">
